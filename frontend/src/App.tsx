...
class Welcome extends React.Component{
  render() {
    return(<h1 style={{color: 'darksalmon'}}>View all the NCAA basketball teams here!</h1>)
  }
}
  ...
  render() {
      ...
      <div style={
    {
     border: '2px solid gray'
        ...
        <h3 style={{color: 'teal'}}>{team.school} {team.name}</h3>
        <p style={{color: 'darksalmon'}}>{team.city}, {team.state}</p>
      </div>
    )
  }
}
